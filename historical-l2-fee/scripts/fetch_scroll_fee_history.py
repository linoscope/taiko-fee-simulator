...
def main():
    parser = argparse.ArgumentParser(
        description="Fetch Scroll historical base fee/gas usage over a time window with throttled batched RPC."
    )
    parser.add_argument("--rpc", default="https://scroll-rpc.publicnode.com", help="Scroll JSON-RPC endpoint")
    parser.add_argument(
        "--window-summary",
    ...
    print("Locating Scroll block bounds for timestamp window...")
    ...
    csv_base = f"scroll_fee_{start_block}_{end_block}_step{stride_blocks}_{stamp}"
