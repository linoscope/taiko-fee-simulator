...
def main():
    parser = argparse.ArgumentParser(
        description="Fetch World Chain historical base fee/gas usage over a time window with throttled batched RPC."
    )
    parser.add_argument(
        "--rpc",
        default="https://worldchain-mainnet.g.alchemy.com/public",
        help="World Chain JSON-RPC endpoint",
    )
    parser.add_argument(
        "--window-summary",
    ...
    print("Locating World Chain block bounds for timestamp window...")
    ...
    csv_base = f"world_fee_{start_block}_{end_block}_step{stride_blocks}_{stamp}"
