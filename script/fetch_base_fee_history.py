...
def main():
    parser = argparse.ArgumentParser(
        description="Fetch Base historical base fee/gas usage over a time window with throttled batched RPC."
    )
    parser.add_argument("--rpc", default="https://mainnet.base.org", help="Base JSON-RPC endpoint")
    parser.add_argument(
        "--window-summary",
        default=os.path.join(os.path.dirname(__file__), "..", "data", "eth_l1_fee_365d_20260207T042811Z_summary.json"),
    ...
    print("Locating Base block bounds for timestamp window...")
    ...
    csv_base = f"base_fee_{start_block}_{end_block}_step{stride_blocks}_{stamp}"
