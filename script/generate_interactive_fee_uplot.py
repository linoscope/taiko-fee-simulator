...
<head>
  ...
  <style>
    ...
    * {{ box-sizing: border-box; }}
    ...
    .advanced-metrics > summary::-webkit-details-marker {{
      display: none;
    }}
    .advanced-metrics > summary::before {{
      content: "▸ ";
      color: #64748b;
      font-weight: 700;
    }}
    .advanced-metrics[open] > summary::before {{
      content: "▾ ";
    }}
...
<body>
    ...
    <div class=\"layout\">
      <aside class=\"panel sidebar\">
        ...
        <div class=\"assumptions\">
          <div class=\"assumptions-title\">L2 demand assumptions</div>
          <div class=\"controls\">
        ...
        <div class=\"assumptions\" id=\"paramsCard\">
          <div class=\"title-row\">
            <div class=\"assumptions-title\">Fee controller parameters</div>
            <button id=\"controllerHelpBtn\" class=\"help-btn\" type=\"button\" title=\"Explain controller model\">?</button>
          </div>
          ...
          <div class=\"formula\">See <strong>?</strong> for equations and modeling assumptions.</div>
          <div class=\"formula\">Derived throughput: <strong id=\"derivedL2GasPerL1Block\">-</strong> and <strong id=\"derivedL2GasPerProposal\">-</strong></div>
          <div class=\"metrics\">
          ...
          <details class=\"advanced-metrics\">
            <summary>Advanced live metrics</summary>
            <div class=\"metrics\">
  ...
  <div id=\"controllerHelpModal\" class=\"help-modal\" aria-hidden=\"true\" role=\"dialog\" aria-modal=\"true\" aria-labelledby=\"controllerHelpTitle\">
    <div class=\"help-card\">
      <div class=\"help-head\">
        <h2 id=\"controllerHelpTitle\" class=\"help-title\">Controller Model Notes</h2>
